...
.veiculos-pagination-controls {
  display: flex;
  align-items: center;
  gap: 8px;
}

.veiculos-pagination-btn {
  display: inline-flex;
  align-items: center;
  gap: 6px;
  padding: 7px 14px;
...
.veiculos-pagination-btn:hover:not(:disabled) {
  background: #f9fafb;
  border-color: #d1d5db;
}

.veiculos-pagination-btn:disabled {
  color: #cbd5e1;
  cursor: not-allowed;
}

.veiculos-pagination-btn svg {
  width: 16px;
  height: 16px;
}

.veiculos-pagination-pages {
  display: flex;
  align-items: center;
  gap: 4px;
}

.veiculos-pagination-page {
  min-width: 32px;
  height: 32px;
  padding: 0 10px;
  font-size: 13px;
...
.veiculos-pagination-page:hover {
  background: #f3f4f6;
}

.veiculos-pagination-page--active {
  background: #004790;
  color: #fff;
  border-color: #004790;
}

.veiculos-pagination-page--active:hover {
  background: #003570;
  border-color: #003570;
}

.veiculos-pagination-ellipsis {
  padding: 0 4px;
  color: #9ca3af;
}
